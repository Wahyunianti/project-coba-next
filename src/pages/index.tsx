          ...
          <div className="w-full h-dvh p-0 md:p-5 flex flex-row items-center justify-center z-100">
            <div className="w-1/2 h-auto md:flex flex-col hidden">
              <div className="w-full h-auto p-10">
                <h1 className="text-6xl font-bold text-red-950">Suzuki Alsut</h1>
                <h1 className="text-4xl font-bold mt-2">Admin Panel</h1>
              </div>
            ...
            <div className="w-full md:w-1/2 h-auto px-10 md:px-15 grid place-items-center">
              <div className="min-h-180 h-auto bg-white w-full rounded-xl shadow-md ">
                <div className="p-7 md:p-10">
                  <h2 className="text-2xl font-bold mb-5">Selamat Datang di Admin Panel Suzuki Alsut</h2>
